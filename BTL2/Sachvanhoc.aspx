<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sachvanhoc.aspx.cs" Inherits="BTL2.Sachvanhoc" %>
...
<head runat="server">
    ...
    <link href="CSS/Sachvanhoc.css" rel="stylesheet" />
</head>
<body>
     <div class="header">
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Sachvanhoc.aspx"><strong>Sách Văn Học</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="sachvanhoc1" runat="server">
                    <ItemTemplate>
